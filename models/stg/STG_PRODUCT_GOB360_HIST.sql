...
with hist as (
    select
        ...
        marketing_end_date,
        expiration_date,
        trim(coalesce(substance, brand_name)) as substance,
        ...
        trim(competitor_indicator) as competitor_indicator,
    ...
    from {{ target.database }}.DW_DFHPMS2EU_SEMARCHY_SCHEMA.LATAM_GOB360_HIST
